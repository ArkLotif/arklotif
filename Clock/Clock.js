function startTime() {
    ...
    document.getElementById("Hour").style.fontSize = timeFontSize = "px";
    document.getElementById("Divider").style.fontSize = timeFontSize = "px";
    document.getElementById("Minute").style.fontSize = timeFontSize = "px";
